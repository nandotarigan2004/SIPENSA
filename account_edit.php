    ...
    <div class="col-lg-5">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" name="nama" value="<?php echo $data['nama_pengguna']; ?>" readonly="readonly">
            </div>
            <div class="form-group">
        ...
        <form method="post">
            <div class="form-group">
                <label>Nama Lengkap</label>
                <input class="form-control" name="nama_pengguna" value="<?php echo $data['nama_pengguna']; ?>">
            </div>
            <div class="form-group">
                <label>Username</label>
        ...
        if(@$_POST['edit']){
            ...
            $query=mysql_query("UPDATE tb_pengguna SET nama_pengguna='$nama_pengguna', username='$username', pass='$pass'  WHERE id_pengguna='$id'") or die (mysql_error());
